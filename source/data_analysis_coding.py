...
# creating a regression table using the pystout library, which formats the results of the logit regression into a LaTeX table. 
# Then taking the .tex file generated by pystout, wraps it in a full LaTeX document, compiles it to PDF, and then converts the PDF to a PNG image. This allows us to easily include the regression table as an image in our website. then deleting the intermediate files generated during the process
...
#Inject custom stats into the .tex file
...
#Read updated .tex and wrap in full LaTeX document
with open(tex_path, 'r') as f:
...
#Compile to PDF, catching errors
...
#Convert PDF to PNG and crop whitespace
